...
{
    return mavlink_msg_usv_state_pack(system_id, component_id, msg, usv_state->longitude, usv_state->latitude, usv_state->speed, usv_state->heading, usv_state->battery_voltage);
}
...
{
    return mavlink_msg_usv_state_pack_chan(system_id, component_id, chan, msg, usv_state->longitude, usv_state->latitude, usv_state->speed, usv_state->heading, usv_state->battery_voltage);
}
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_usv_state_send(chan, usv_state->longitude, usv_state->latitude, usv_state->speed, usv_state->heading, usv_state->battery_voltage);
#else
